...
\projectinfo{
    ...
    title={Prostředí pro vizuální návrh, monitorování a správu distribuovaných řídicích systémů a IoT sítí},
    title.footer={Prostředí pro vizuální návrh, monitorování a správu distribuovaných řídicích systémů a IoT sítí},
    author.name={Jakub},
    author.surname={Kapitulčín},
    author.title.first={},
    supervisor.name={Vladimír},
    supervisor.surname={Janoušek},
    supervisor.title.first={doc. Ing.},
...
\begin{document}
    ...
    \input{slides_en}  % Slides in English
\end{document}
