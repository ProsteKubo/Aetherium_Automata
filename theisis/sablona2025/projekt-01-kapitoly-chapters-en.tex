...
The server is an Elixir/OTP application. It manages the registry of connected devices, buffers messages, routes inputs to devices and outputs to subscribers, and handles deployment commands. It communicates with devices over WebSocket as the primary transport; a transport-plugin interface allows additional backends to be registered without changing the core.
