...
\projectinfo{
  ...
  % TODO: translate keywords to Czech for the cs field
  keywords.cs={rozšířený konečný automat, Petriho síť, IoT, distribuované řídicí systémy, stavový stroj, Lua, vestavěné systémy, vizuální IDE, vstřikování chyb, ladění s přetáčením času},
...
I used Claude Code (an AI programming assistant by Anthropic) for code assistance and documentation generation during the development of the implemented system.},
